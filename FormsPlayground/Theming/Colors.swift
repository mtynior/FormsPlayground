...
public extension UIColor {
    ...
    static let myColor2 = UIColor(named: "myColor2")
    static let myColor3 = UIColor(named: "myColor3")
    static let myColor4 = UIColor(named: "myColor4")
...
public extension Color {
    enum Palette {
        ...
        public static let myColor2 = Color("myColor2")
        ...
        public static let myColor6 = Color("myColor7")
    }
}
